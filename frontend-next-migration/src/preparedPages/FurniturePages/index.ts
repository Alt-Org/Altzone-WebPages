export { default as FurnitureSetsPage } from './ui/FurnitureSetsPage/FurnitureSetsPage.async';
export type { FurniturePageProps } from './ui/FurnitureSetsPage/FurnitureSetsPage';
export { default as FurnitureOneSetPage } from './ui/OneFurnitureSetPage/OneSetPage.async';
export type { FurnitureOneSetPageProps } from './ui/OneFurnitureSetPage/OneSetPage';
