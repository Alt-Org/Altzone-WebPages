            ...
            <DescriptionCard theme={DescriptionCardTheme.TEACHERS}>
                <DescriptionCard.Texts>
                    ...
                    <DescriptionCard.Texts.Body>
                        ...
                        <p>
                            Opettajan paneelissa kohdassa Omat oppitunnit voit luoda uuden
                            oppitunnin antamalla sille sopivan tunnisteen (esim. 7B-luokka) sekä
                            selata ja poistaa luomiasi oppitunteja.
                        </p>
                        <p>
                        ...
                        <p>
                            Opetukseen valmistautumisen yhteyteen on tehty perusteelliset
                            infopaketit liittyen mm. pelitaiteeseen sekä tämän opetuspaketin
                            sisältämiin pelilukutaitoihin ja niiden tehtäviin.
                        </p>
                    </DescriptionCard.Texts.Body>
                </DescriptionCard.Texts>
            </DescriptionCard>
                ...
                <DescriptionCard.Texts>
                    ...
                    <DescriptionCard.Texts.Body>
                        ...
                        <p>
                            ...
                            vapautuu seuraaville oppitunneille. Suositeltavaa myös on, että
                            suoritettu oppitunti poistetaan mahdollisimman pian. Mikäli opettaja
                            jättää poistamatta aikaisemmin luodun oppitunnin, se katsotaan
                            vanhentuneeksi X kuukauden kuluttua oppitunnin luomisesta ja poistuu
                            silloin järjestelmästä automaattisesti.
                        </p>
                        <h2>Oppitunnin toteutus</h2>
                        <p>
                            Oppituntiin sisällytetään kaksi klaania, jotka kilpailevat keskenään
                            testauksen ajan. Tutustukaa ensin pelilukutaidon tehtäviin ja
                            pelitaiteen opetusmateriaaliin ja varatkaa tälle aikaa noin XX.
                        </p>
                        <p>
                        ...
                        <p>
                            Testauksen aikana oppilaat suorittavat tehtäviä eri pelilukutaidon
                            osioista. Testauksen päättymisen jälkeen tulokset on nähtävillä
                            tulostaulukosta. Testausosuuteen on hyvä varata aikaa noin 20 minuuttia.
                        </p>
