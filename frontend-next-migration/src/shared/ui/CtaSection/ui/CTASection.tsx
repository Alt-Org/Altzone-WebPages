...
export const CTASection = (props: Props) => {
    ...
    // Check if link is Discord
    const isDiscordLink = (link: string) => link.includes('discord');
                        ...
                        {links && links.length > 0 && (
                            <div className={cls.LinksContainer}>
                                {links.map((item, index) => {
                                    const isDiscord = isDiscordLink(item.link);
                                    return (
                                        <Button
                                            key={index}
                                            path={item.link}
                                            ...
                                            className={
                                                isDiscord ? cls.DiscordButton : cls.LinkButton
                                            }
                                        >
