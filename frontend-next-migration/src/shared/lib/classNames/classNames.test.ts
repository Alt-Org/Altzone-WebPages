...
describe('classNames', () => {
    ...
    it('should return a string of class names separated by a space', () => {
        ...
        expect(classNames('main-class', { active: true })).toBe('main-class active');
        expect(classNames('main-class', { active: true }, ['additional-class'])).toBe(
            'main-class active additional-class',
        );
    });
    ...
    it('should support multiple mods', () => {
        ...
        expect(classNames('main-class', { active: true, disabled: true })).toBe(expected);
    });
    ...
    it('should support additional class names', () => {
        ...
        expect(classNames('main-class', {}, ['additional-class', 'second-class'])).toBe(
            'main-class additional-class second-class',
        );
        expect(classNames('main-class', {}, [])).toBe('main-class');
    });
});
