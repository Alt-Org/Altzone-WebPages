...
const NavbarTouchComponent = (props: NavbarTouchProps) => {
    ...
    return (
        ...
        <nav className={classNames(cls.Navbar, mods, [className])} style={style} >
            <div
                className={classNames(cls.NavbarMobile__burger, sidebarMods, [hidden,disabled])}
                onClick={handleBurgerClick}
            >
            </div>
            <Sidebar
                sidebarItemsListResetKey={sidebarItemsListResetKey}
                buttonClassName={classNames(cls.NavbarMobile__burger, sidebarMods,[hidden,disabled])}
