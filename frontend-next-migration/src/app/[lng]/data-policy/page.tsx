    ...
    return (
        ...
        <DataPolicyPage
            ...
            text={"Under GDPR, you have the following rights:\n" +
                ...
                "\n" +
                "\n" +
                "We retain your personal data for as long as it is necessary to fulfill the purposes described above or until you request the deletion of your data. You can request the deletion of your data at any time by sending an informal request via email to proyaleg@gmail.com. Upon such a request, all data related to you will be permanently and irrevocably deleted unless there is a legal requirement to retain the data."}
        />
    );
}