...
export const newsDataLocally: INewsElement[] = [
    {
        ...
        bodyPreview:
            'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi autem beatae doloremque impedit minima, non quam quibusdam quis quisquam repellat,',
        bodyElements: [
            {
                type: 'image',
                widthPx: 600,
...
`,
            },
            {
                type: 'image',
                heightPx: 500,
                url: 'https://images.unsplash.com/flagged/photo-1557427161-4701a0fa2f42?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxleHBsb3JlLWZlZWR8MXx8fGVufDB8fHx8&auto=format&fit=crop&w=500&q=60',
                alt: 'Image 2',
            },
            {
                type: 'text',
        ...
        bodyElements: [
            {
                type: 'image',
                widthPx: 600,
                url: 'https://hips.hearstapps.com/hmg-prod/images/golden-retriever-royalty-free-image-506756303-1560962726.jpg?crop=1.00xw:0.756xh;0,0.0756xh&resize=1200:*',
                alt: 'Image 1',
            },
