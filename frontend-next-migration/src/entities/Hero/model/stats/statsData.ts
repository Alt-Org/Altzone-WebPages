...
const createBaseLevels = (): Record<HeroLevel, HeroStats> => ({
    1: {
...
export const statsData: Record<HeroSlug, Record<HeroLevel, HeroStats>> = {
    [HeroSlug.OVEREATER]: createBaseLevels(),
    [HeroSlug.PROVOCATEUR]: createBaseLevels(),
    [HeroSlug.MIRROR]: createBaseLevels(),
    [HeroSlug.RESEARCHER]: createBaseLevels(),
    [HeroSlug.CONMAN]: createBaseLevels(),
    [HeroSlug.JOKESTER]: createBaseLevels(),
    [HeroSlug.SLEEPY_SLEEPER]: createBaseLevels(),
    [HeroSlug.BELIEVER]: createBaseLevels(),
    [HeroSlug.SOUL_SISTERS]: createBaseLevels(),
    [HeroSlug.ALCOHOLIC]: createBaseLevels(),
    [HeroSlug.HATE_SPEECH]: createBaseLevels(),
    [HeroSlug.MEATWALL]: createBaseLevels(),
    [HeroSlug.VETERAN]: createBaseLevels(),
};
