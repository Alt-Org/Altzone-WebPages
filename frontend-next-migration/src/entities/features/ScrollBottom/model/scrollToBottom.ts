 ...
 */
const linear = (elapsedTime: number, currentPosition: number, distance: number, speedInMs: number) => {
 ...
 */
export const scrollToBottom = (speedInMs: number, animationFrameIdRef: MutableRefObject<number>) => {
